      ...
      <section aria-labelledby="dashboards-heading" className="space-y-3">
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
          ...
          >
            ...
            <span
              aria-hidden="true"
              className="flex h-11 w-11 shrink-0 items-center justify-center rounded-md bg-fluxo-500/10 text-fluxo-600 ring-1 ring-inset ring-fluxo-500/20"
            >
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-400">
                Cumprimento de prazo do mês + risco operacional agora · por cliente e agente.
              </p>
            </div>
            <ArrowRight className="h-4 w-4 text-slate-400 transition-transform group-hover:translate-x-1" aria-hidden="true" />
          </Link>
